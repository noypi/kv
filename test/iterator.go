...
func batchWriteRows(s kv.KVStore, rows []testRow) error {
	// open a writer
	writer, err := s.Writer()
	if err != nil {
		return err
...
func CommonTestPrefixIterator(t *testing.T, s kv.KVStore) {
...
func CommonTestPrefixIteratorSeek(t *testing.T, s kv.KVStore) {
...
func CommonTestRangeIterator(t *testing.T, s kv.KVStore) {
...
func CommonTestRangeIteratorSeek(t *testing.T, s kv.KVStore) {
